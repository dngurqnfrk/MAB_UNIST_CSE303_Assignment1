...
from algorithms_student import student_algorithm1
from algorithms_student import student_algorithm2
...
def main() -> None:
    ...
    print_environment_results(
        envs=get_my_hidden_envs(),
        algos=algos,
        horizon=horizon,
        seeds=seeds,
        evaluate_algorithm=evaluate_algorithm,
        title="My hidden evaluation (per environment)",
    )
